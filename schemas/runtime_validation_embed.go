...
//
//go:embed discord-bot-start-job-request.schema.json encoder-video-cover-apply-request.schema.json encoder-video-cover-apply-response.schema.json encoder-video-cover-runtime-state.schema.json encoder-video-cover-unavailable-response.schema.json
