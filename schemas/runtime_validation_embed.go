...
//
//go:embed discord-bot-start-job-request.schema.json encoder-video-cover-apply-request.schema.json encoder-video-cover-apply-response.schema.json encoder-video-cover-runtime-state.schema.json encoder-video-cover-unavailable-response.schema.json updater-desired-operation.schema.json system-update-job.schema.json system-update-port-v2.schema.json host-agent-self-update-directive.schema.json host-self-update-release-binding.schema.json
